...
class BigWord2VecMatrixSpec extends FlatSpec with SystemTest with Matchers {
  ...
  implicit val tolerance = TolerantNumerics.tolerantFloatEquality(0.000000001f)
    ...
    withServers(3) { _ =>
      withClient { client =>
        ...
        values should equal(Array(
          0.076989256f, 0.076959394f, 0.07704898f, 0.11048033f, -0.13317561f, -0.0688745f,
          -0.08648787f, -0.02997307f, 0.13381587f, 0.03544839f, -0.030853411f, -0.16528131f))
      }
    }
  }
